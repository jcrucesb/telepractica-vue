<template>
    <div id="editarRegistroPracticante">
        <form action="" enctype="multipart/form-data" onsubmit="comprobarChecks(event);">
                ...
                <div class="container mt-5">
                    ...
                    <div class="container">
                        ...
                        <br>
                        <label for="carrera">Selección de Carrera</label>
                            <select name="" id="" v-model="form.carrera">
                            <option v-for="opcion in carrera" :value="opcion.id" :key="opcion.id">
                                {{ opcion.nombre }}
                            </option>
                        </select>          
                    </div>
...
export default {
    ...
    methods: {
        ...
        registrarPracticante(){
            ...
            console.log(formDa.append('cantidadHora',this.form.cantidadHora));
            debugger;
            ...
            console.log(formDa.append('carrera',this.form.carrera));
            ...
            .catch(e => {
                ...
                cthis.$toastr.e("No se pudo bajar usuario", "Error");
            });
        },
    },
}
